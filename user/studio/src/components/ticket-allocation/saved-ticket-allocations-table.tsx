...
export function SavedTicketAllocationsTable({ refreshKey }: { refreshKey: number }) {
  ...
  if (loading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Saved Client Allocations</CardTitle>
          <CardDescription>History of all saved client ticket ratio allocations.</CardDescription>
        </CardHeader>
        <CardContent>
